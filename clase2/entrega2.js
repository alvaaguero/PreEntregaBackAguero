...
class ProductManager{
        ...
        addProduct=async(title,description,price,thumbnail,code,stock)=>{
          ...
          updateProduct=async(id,title,description,price,thumbnail,code,stock)=>{
            if(!id|| !title || !description || !price || !thumbnail|| !code||!stock){
              console.error("ingrese datos de product.")
              return 
            }
            else{
    ...
    async function generator(){
        ...
        // await productmanager.addProduct("producto1","descripcion1",1500,"url","abc123",500)
        // await productmanager.addProduct("producto2","descripcion2",1500,"url","abc122",500)
        // await productmanager.addProduct("producto3","descripcion3",1500,"url","abc125",500)
